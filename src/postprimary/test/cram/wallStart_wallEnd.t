...
Test on other simulated data:
  $ baz=/pbi/dept/primary/sim/spider/kestrel-test-new-header-zmw-info/internal.baz
...
Check that sf and ws/we match:
  ...
  $ baz=/pbi/dept/primary/sim/spider/kestrel-test-new-header-zmw-info/prod.baz
  $ meta=$TESTDIR/data/metadata.xml
  $ bam=out_production
