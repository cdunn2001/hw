...
# Generate complete metrics by disabling preHQ algorithm.
  ...
  \t\t\t\t\t"BPZVAR_C" : 0.00065755844116210938, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0.00031161308288574219, (esc)
  ...
  \t\t\t\t\t"BASE_WIDTH" : 2008, (esc)
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0.0011148452758789062, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0.0012845993041992188, (esc)
  ...
  \t\t\t\t\t"BASE_WIDTH" : 2048, (esc)
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0.0011444091796875, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0.001689910888671875, (esc)
  \t\t\t\t\t"BPZVAR_T" : 0.0009746551513671875, (esc)
  \t\t\t\t\t"DME_STATUS" : 0, (esc)
  \t\t\t\t\t"ID" : 2, (esc)
  \t\t\t\t\t"NUM_BASES_A" : 25, (esc)
  \t\t\t\t\t"NUM_BASES_C" : 25, (esc)
  ...
  \t\t\t\t\t"BASE_WIDTH" : 2005, (esc)
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0.00068569183349609375, (esc)
  ...
  \t\t\t\t\t"TRACE_AUTOCORR" : 0.7080078125 (esc)
  \t\t\t\t} (esc)
  \t\t\t], (esc)
  \t\t\t"ZMW_ID" : 0, (esc)
  \t\t\t"ZMW_NUMBER" : 0 (esc)
