...
# Run again but set the hqThrottleFraction=0.25 so start of HQ-region is different resulting in a preHQ metric block with data.
  ...
  \t\t\t\t{ (esc)
  \t\t\t\t\t"ACTIVITY_LABEL" : 1, (esc)
  \t\t\t\t\t"BASELINE_MEAN" : 0.006359100341796875, (esc)
  \t\t\t\t\t"BASELINE_SD" : 5.84375, (esc)
  \t\t\t\t\t"BASE_WIDTH" : 24930, (esc)
  \t\t\t\t\t"DME_STATUS" : 0, (esc)
  \t\t\t\t\t"ID" : 1, (esc)
  \t\t\t\t\t"NUM_BASES_A" : 369, (esc)
  \t\t\t\t\t"NUM_BASES_C" : 375, (esc)
  ...
  \t\t\t\t\t"PKMID_A" : 230.5, (esc)
  \t\t\t\t\t"PKMID_C" : 157.375, (esc)
  \t\t\t\t\t"PKMID_FRAMES_A" : 7038, (esc)
  \t\t\t\t\t"PKMID_FRAMES_C" : 6367, (esc)
  \t\t\t\t\t"PKMID_FRAMES_G" : 4641, (esc)
  \t\t\t\t\t"PKMID_FRAMES_T" : 4390, (esc)
  \t\t\t\t\t"PKMID_G" : 100.9375, (esc)
  \t\t\t\t\t"PKMID_T" : 63.09375, (esc)
  \t\t\t\t\t"PULSE_WIDTH" : 25013 (esc)
  \t\t\t\t} (esc)
  \t\t\t], (esc)
  \t\t\t"ZMW_ID" : 1, (esc)
  \t\t\t"ZMW_NUMBER" : 1 (esc)
