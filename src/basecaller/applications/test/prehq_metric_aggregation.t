...
# Generate complete metrics by disabling preHQ algorithm.
  ...
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0.0013437271118164062, (esc)
  \t\t\t\t\t"BPZVAR_T" : 0.0021076202392578125, (esc)
  \t\t\t\t\t"DME_STATUS" : 0, (esc)
  \t\t\t\t\t"ID" : 1, (esc)
  \t\t\t\t\t"NUM_BASES_A" : 23, (esc)
  \t\t\t\t\t"NUM_BASES_C" : 23, (esc)
  ...
  \t\t\t\t\t"BASE_WIDTH" : 2056, (esc)
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0.00058746337890625, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0.0015316009521484375, (esc)
  \t\t\t\t\t"BPZVAR_T" : 0.00052928924560546875, (esc)
  \t\t\t\t\t"DME_STATUS" : 0, (esc)
  \t\t\t\t\t"ID" : 2, (esc)
  \t\t\t\t\t"NUM_BASES_A" : 25, (esc)
  \t\t\t\t\t"NUM_BASES_C" : 25, (esc)
  ...
  \t\t\t\t\t"BASE_WIDTH" : 2012, (esc)
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0.00025010108947753906, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0.00124359130859375, (esc)
  \t\t\t\t\t"BPZVAR_T" : 0.00077867507934570312, (esc)
  \t\t\t\t\t"DME_STATUS" : 0, (esc)
  \t\t\t\t\t"ID" : 3, (esc)
  \t\t\t\t\t"NUM_BASES_A" : 23, (esc)
  \t\t\t\t\t"NUM_BASES_C" : 24, (esc)
