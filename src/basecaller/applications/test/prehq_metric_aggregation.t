...
# metric blocks should be aggregated into one as the activity labels are all the same.
  ...
  \t\t\t\t}, (esc)
  \t\t\t\t{ (esc)
  \t\t\t\t\t"BASELINE_MEAN" : 6.33203125, (esc)
  \t\t\t\t\t"BASELINE_SD" : 13.796875, (esc)
  ...
  \t\t\t\t\t"PKMID_FRAMES_C" : 5064, (esc)
  \t\t\t\t\t"PKMID_FRAMES_G" : 4927, (esc)
  \t\t\t\t\t"PKMID_FRAMES_T" : 7850, (esc)
  \t\t\t\t\t"PKMID_G" : 99.4375, (esc)
  \t\t\t\t\t"PKMID_T" : 62.875, (esc)
  \t\t\t\t\t"PKZVAR_A" : 0, (esc)
  \t\t\t\t\t"PKZVAR_C" : 0, (esc)
...
# Run again but set the hqThrottleFraction=0.25 so start of HQ-region is different resulting in a preHQ metric block with data.
  ...
  \t\t\t[ (esc)
  \t\t\t\t{ (esc)
  \t\t\t\t\t"BASELINE_MEAN" : 0.10186767578125, (esc)
  \t\t\t\t\t"BASELINE_SD" : 5.2421875, (esc)
  \t\t\t\t\t"BASE_WIDTH" : 281, (esc)
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0, (esc)
  ...
  \t\t\t\t\t"PKMID_FRAMES_C" : 0, (esc)
  \t\t\t\t\t"PKMID_FRAMES_G" : 174, (esc)
  \t\t\t\t\t"PKMID_FRAMES_T" : 70, (esc)
  \t\t\t\t\t"PKMID_G" : 100.6875, (esc)
  \t\t\t\t\t"PKMID_T" : 64.25, (esc)
  \t\t\t\t\t"PKZVAR_A" : 0, (esc)
  \t\t\t\t\t"PKZVAR_C" : 0, (esc)
  \t\t\t\t\t"PKZVAR_G" : 0, (esc)
  ...
  \t\t\t\t}, (esc)
  \t\t\t\t{ (esc)
  \t\t\t\t\t"BASELINE_MEAN" : 2.35546875, (esc)
  \t\t\t\t\t"BASELINE_SD" : 5.9921875, (esc)
  \t\t\t\t\t"BASE_WIDTH" : 1921, (esc)
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0, (esc)
  ...
  \t\t\t\t\t"PKZVAR_T" : 0, (esc)
  \t\t\t\t\t"PULSE_DETECTION_SCORE" : 0, (esc)
  \t\t\t\t\t"PULSE_WIDTH" : 1923, (esc)
  \t\t\t\t\t"TRACE_AUTOCORR" : 0 (esc)
  \t\t\t\t}, (esc)
  \t\t\t\t{ (esc)
  \t\t\t\t\t"BASELINE_MEAN" : 3.9296875, (esc)
  \t\t\t\t\t"BASELINE_SD" : 7.3984375, (esc)
  \t\t\t\t\t"BASE_WIDTH" : 1929, (esc)
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0, (esc)
  ...
  \t\t\t\t\t"PKMID_FRAMES_G" : 388, (esc)
  \t\t\t\t\t"PKMID_FRAMES_T" : 387, (esc)
  \t\t\t\t\t"PKMID_G" : 102.8125, (esc)
  \t\t\t\t\t"PKMID_T" : 64.4375, (esc)
  \t\t\t\t\t"PKZVAR_A" : 0, (esc)
  \t\t\t\t\t"PKZVAR_C" : 0, (esc)
  \t\t\t\t\t"PKZVAR_G" : 0, (esc)
  \t\t\t\t\t"PKZVAR_T" : 0, (esc)
  \t\t\t\t\t"PULSE_DETECTION_SCORE" : 0, (esc)
  \t\t\t\t\t"PULSE_WIDTH" : 1929, (esc)
  \t\t\t\t\t"TRACE_AUTOCORR" : 0 (esc)
  \t\t\t\t}, (esc)
  \t\t\t\t{ (esc)
  \t\t\t\t\t"BASELINE_MEAN" : 5.6953125, (esc)
  ...
  \t\t\t\t\t"PKZVAR_T" : 0, (esc)
  \t\t\t\t\t"PULSE_DETECTION_SCORE" : 0, (esc)
  \t\t\t\t\t"PULSE_WIDTH" : 1916, (esc)
  \t\t\t\t\t"TRACE_AUTOCORR" : 0 (esc)
  \t\t\t\t}, (esc)
  \t\t\t\t{ (esc)
  \t\t\t\t\t"BASELINE_MEAN" : 6.79296875, (esc)
  \t\t\t\t\t"BASELINE_SD" : 10.109375, (esc)
  \t\t\t\t\t"BASE_WIDTH" : 1929, (esc)
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0, (esc)
  ...
  \t\t\t\t\t"PKMID_FRAMES_G" : 388, (esc)
  \t\t\t\t\t"PKMID_FRAMES_T" : 387, (esc)
  \t\t\t\t\t"PKMID_G" : 101.8125, (esc)
  \t\t\t\t\t"PKMID_T" : 63.46875, (esc)
  \t\t\t\t\t"PKZVAR_A" : 0, (esc)
  \t\t\t\t\t"PKZVAR_C" : 0, (esc)
  \t\t\t\t\t"PKZVAR_G" : 0, (esc)
  \t\t\t\t\t"PKZVAR_T" : 0, (esc)
  ...
  \t\t\t\t}, (esc)
  \t\t\t\t{ (esc)
  \t\t\t\t\t"BASELINE_MEAN" : 7.65625, (esc)
  \t\t\t\t\t"BASELINE_SD" : 11.2109375, (esc)
  \t\t\t\t\t"BASE_WIDTH" : 1909, (esc)
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0, (esc)
  ...
  \t\t\t\t\t"PKZVAR_T" : 0, (esc)
  \t\t\t\t\t"PULSE_DETECTION_SCORE" : 0, (esc)
  \t\t\t\t\t"PULSE_WIDTH" : 1913, (esc)
  \t\t\t\t\t"TRACE_AUTOCORR" : 0 (esc)
  \t\t\t\t}, (esc)
  \t\t\t\t{ (esc)
  \t\t\t\t\t"BASELINE_MEAN" : 8.1640625, (esc)
  \t\t\t\t\t"BASELINE_SD" : 12.5078125, (esc)
  \t\t\t\t\t"BASE_WIDTH" : 1927, (esc)
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0, (esc)
  ...
  \t\t\t\t\t"PKZVAR_T" : 0, (esc)
  \t\t\t\t\t"PULSE_DETECTION_SCORE" : 0, (esc)
  \t\t\t\t\t"PULSE_WIDTH" : 1927, (esc)
  \t\t\t\t\t"TRACE_AUTOCORR" : 0 (esc)
  \t\t\t\t}, (esc)
  \t\t\t\t{ (esc)
  \t\t\t\t\t"BASELINE_MEAN" : 8.6015625, (esc)
  \t\t\t\t\t"BASELINE_SD" : 13.59375, (esc)
  \t\t\t\t\t"BASE_WIDTH" : 1908, (esc)
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0, (esc)
  ...
  \t\t\t\t}, (esc)
  \t\t\t\t{ (esc)
  \t\t\t\t\t"BASELINE_MEAN" : 8.8125, (esc)
  \t\t\t\t\t"BASELINE_SD" : 14.8125, (esc)
  \t\t\t\t\t"BASE_WIDTH" : 1925, (esc)
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0, (esc)
  ...
  \t\t\t\t}, (esc)
  \t\t\t\t{ (esc)
  \t\t\t\t\t"BASELINE_MEAN" : 8.9609375, (esc)
  \t\t\t\t\t"BASELINE_SD" : 15.875, (esc)
  \t\t\t\t\t"BASE_WIDTH" : 1908, (esc)
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0, (esc)
  ...
  \t\t\t[ (esc)
  \t\t\t\t{ (esc)
  \t\t\t\t\t"BASELINE_MEAN" : 2.2734375, (esc)
  \t\t\t\t\t"BASELINE_SD" : 6.1875, (esc)
  \t\t\t\t\t"BASE_WIDTH" : 2090, (esc)
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0, (esc)
  ...
  \t\t\t\t\t"PKZVAR_T" : 0, (esc)
  \t\t\t\t\t"PULSE_DETECTION_SCORE" : 0, (esc)
  \t\t\t\t\t"PULSE_WIDTH" : 2094, (esc)
  \t\t\t\t\t"TRACE_AUTOCORR" : 0 (esc)
  \t\t\t\t}, (esc)
  \t\t\t\t{ (esc)
  \t\t\t\t\t"BASELINE_MEAN" : 9.6171875, (esc)
  \t\t\t\t\t"BASELINE_SD" : 14.1875, (esc)
  \t\t\t\t\t"BASE_WIDTH" : 21881, (esc)
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0, (esc)
  \t\t\t\t\t"BPZVAR_T" : 0, (esc)
  ...
  \t\t\t\t\t"PKMID_A" : 230.75, (esc)
  \t\t\t\t\t"PKMID_C" : 157, (esc)
  \t\t\t\t\t"PKMID_FRAMES_A" : 5582, (esc)
  \t\t\t\t\t"PKMID_FRAMES_C" : 3935, (esc)
  \t\t\t\t\t"PKMID_FRAMES_G" : 5284, (esc)
  \t\t\t\t\t"PKMID_FRAMES_T" : 5086, (esc)
...
# Generate complete metrics by disabling preHQ algorithm.
  ...
  \t\t\t[ (esc)
  \t\t\t\t{ (esc)
  \t\t\t\t\t"BASELINE_MEAN" : 0.65966796875, (esc)
  ...
  \t\t\t\t}, (esc)
  \t\t\t\t{ (esc)
  \t\t\t\t\t"BASELINE_MEAN" : 1.8876953125, (esc)
  ...
  \t\t\t\t}, (esc)
  \t\t\t\t{ (esc)
  \t\t\t\t\t"BASELINE_MEAN" : 4.46484375, (esc)
  \t\t\t\t\t"BASELINE_SD" : 8.7265625, (esc)
  \t\t\t\t\t"BASE_WIDTH" : 2008, (esc)
  \t\t\t\t\t"BPZVAR_A" : 0, (esc)
  \t\t\t\t\t"BPZVAR_C" : 0, (esc)
  \t\t\t\t\t"BPZVAR_G" : 0, (esc)
