...
static std::string JSON_HEADER =
    "{\"TYPE\":\"BAZ\", \"HEADER\":"
    "{\"MOVIE_NAME\":\"ArminsFakeMovie\",\"COMPLETE\":1,\"MOVIE_LENGTH_FRAMES\" : 1080000,\"BASE_CALLER_VERSION\":\"1.2\",\"BAZWRITER_VERSION\":\"1.0\",\"BAZ2BAM_VERSION\":\"3.3\",\"BAZ_MAJOR_VERSION\":0,\"BAZ_MINOR_VERSION\":1,\"BAZ_PATCH_"
    "VERSION\":0,\"FRAME_RATE_HZ\":100,\"HF_METRIC\":{\"FIELDS\":[[\"NUM_PULSES\",16]],\"FRAMES\":512},"
    "\"BASECALLER_CONFIG\": \"{}\","
    ...
    "\"LF_METRIC\":{\"FIELDS\":[[\"BASELINE_RED_SD\",8],[\"PULSE_"
    "WIDTH\",16],[\"BASE_WIDTH\",16],[\"BASELINE_GREEN_SD\",8]"
    ",[\"BASELINE_RED_MEAN\",16]"
    ",[\"BASELINE_GREEN_MEAN\",16]"
    ",[\"NUM_PULSES\",16],[\"NUM_BASES\","
    "16]],\"FRAMES\":16384},\"MF_METRIC\":{\"FIELDS\":[[\"PKMID_A\",8],"
    "[\"PKMID_C\",8],[\"PKMID_G\",8],[\"PKMID_T\",8],[\"NUM_PULSES\","
    "16],[\"NUM_BASES\",16]],\"FRAMES\":4096},\"PACKET\":[[\"READOUT"
    "\",2],[\"DEL_TAG\",3],[\"SUB_TAG\",3],[\"DEL_QV\",4],[\"SUB_"
    "QV\",4],[\"INS_QV\",4],[\"MRG_QV\",4],[\"ALT_QV\",4],[\"LAB_"
    "QV\",4],[\"ALT_LABEL\",4],[\"LABEL\",4],[\"IPD_LL\",8,255,\"IPD16_"
...
TEST(fileheaderInternal, NoData)
{
    const std::string FILENAME1 = "fileheaderInternal_test.baz";
    ...
    EXPECT_EQ(fh.HFMetricFrames(), static_cast<uint32_t>(512));
    ...
    EXPECT_EQ(fh.HFMetricByteSize(), static_cast<uint32_t>(2));
    EXPECT_EQ(fh.MFMetricByteSize(), static_cast<uint32_t>(8));
    EXPECT_EQ(fh.LFMetricByteSize(), static_cast<uint32_t>(14));

    EXPECT_EQ(fh.HFMetricFields().size(), static_cast<uint32_t>(1));
    EXPECT_EQ(fh.HFMetricFields()[0].fieldName == MetricFieldName::NUM_PULSES, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.HFMetricFields()[0].fieldBitSize, static_cast<uint32_t>(16));

    EXPECT_EQ(fh.MFMetricFields().size(), static_cast<uint32_t>(6));
    ...
    EXPECT_EQ(fh.MFMetricFields()[4].fieldName == MetricFieldName::NUM_PULSES, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.MFMetricFields()[4].fieldBitSize, static_cast<uint32_t>(16));
    EXPECT_EQ(fh.MFMetricFields()[5].fieldName == MetricFieldName::NUM_BASES, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.MFMetricFields()[5].fieldBitSize, static_cast<uint32_t>(16));
    ...
    EXPECT_EQ(fh.PacketFields().size(), static_cast<uint32_t>(15));
    ...
    EXPECT_EQ(fh.PacketFields()[7].fieldName == PacketFieldName::ALT_QV, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.PacketFields()[7].fieldBitSize, static_cast<uint32_t>(4));
    EXPECT_EQ(fh.PacketFields()[7].hasFieldEscape, static_cast<uint32_t>(0));
    EXPECT_EQ(fh.PacketFields()[7].fieldBitMask, static_cast<uint32_t>(0b11110000));
    EXPECT_EQ(fh.PacketFields()[7].fieldBitShift, static_cast<uint32_t>(4));
    EXPECT_EQ(fh.PacketFields()[8].fieldName == PacketFieldName::LAB_QV, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.PacketFields()[8].fieldBitSize, static_cast<uint32_t>(4));
    EXPECT_EQ(fh.PacketFields()[8].hasFieldEscape, static_cast<uint32_t>(0));
    EXPECT_EQ(fh.PacketFields()[8].fieldBitMask, static_cast<uint32_t>(0b00001111));
    EXPECT_EQ(fh.PacketFields()[8].fieldBitShift, static_cast<uint32_t>(0));
    EXPECT_EQ(fh.PacketFields()[9].fieldName == PacketFieldName::ALT_LABEL, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.PacketFields()[9].fieldBitSize, static_cast<uint32_t>(4));
    EXPECT_EQ(fh.PacketFields()[9].hasFieldEscape, static_cast<uint32_t>(0));
    EXPECT_EQ(fh.PacketFields()[9].fieldBitMask, static_cast<uint32_t>(0b11110000));
    EXPECT_EQ(fh.PacketFields()[9].fieldBitShift, static_cast<uint32_t>(4));
    EXPECT_EQ(fh.PacketFields()[10].fieldName == PacketFieldName::LABEL, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.PacketFields()[10].fieldBitSize, static_cast<uint32_t>(4));
    EXPECT_EQ(fh.PacketFields()[10].hasFieldEscape, static_cast<uint32_t>(0));
    EXPECT_EQ(fh.PacketFields()[10].fieldBitMask, static_cast<uint32_t>(0b00001111));
    EXPECT_EQ(fh.PacketFields()[10].fieldBitShift, static_cast<uint32_t>(0));
    EXPECT_EQ(fh.PacketFields()[11].fieldName == PacketFieldName::IPD_LL, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.PacketFields()[11].fieldBitSize, static_cast<uint32_t>(8));
    EXPECT_EQ(fh.PacketFields()[11].hasFieldEscape, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.PacketFields()[11].extensionName == PacketFieldName::IPD16_LL, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.PacketFields()[11].extensionBitSize, static_cast<uint32_t>(16));
    EXPECT_EQ(fh.PacketFields()[12].fieldName == PacketFieldName::PW_LL, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.PacketFields()[12].fieldBitSize, static_cast<uint32_t>(8));
    EXPECT_EQ(fh.PacketFields()[12].hasFieldEscape, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.PacketFields()[12].extensionName == PacketFieldName::PW16_LL, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.PacketFields()[12].extensionBitSize, static_cast<uint32_t>(16));
    EXPECT_EQ(fh.PacketFields()[13].fieldName == PacketFieldName::PKMEAN_LL, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.PacketFields()[13].fieldBitSize, static_cast<uint32_t>(8));
    EXPECT_EQ(fh.PacketFields()[13].hasFieldEscape, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.PacketFields()[13].extensionName == PacketFieldName::PKMEAN16_LL, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.PacketFields()[13].extensionBitSize, static_cast<uint32_t>(16));
    EXPECT_EQ(fh.PacketFields()[14].fieldName == PacketFieldName::PKMID_LL, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.PacketFields()[14].fieldBitSize, static_cast<uint32_t>(8));
    EXPECT_EQ(fh.PacketFields()[14].hasFieldEscape, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.PacketFields()[14].extensionName == PacketFieldName::PKMID16_LL, static_cast<uint32_t>(1));
    EXPECT_EQ(fh.PacketFields()[14].extensionBitSize, static_cast<uint32_t>(16));
}
