...
# a change affecting both this repository and pa-third-common.  This should be an uncommon need,
# and if you find yourself needing it, please evaluate your situation to make sure it's truly
...
# If any naming changes then any submodule usage will likely get pushed up to the remote.
#
