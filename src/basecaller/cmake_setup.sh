...
(cd build/x86_64/Debug;           cmake "-G${generator}" --debug-trycompile -DCMAKE_CUDA_HOST_COMPILER=icpc -DCMAKE_BUILD_TYPE=Debug   -DCMAKE_TOOLCHAIN_FILE=TC-icc-cuda-x86_64.cmake ../../..)
(cd build/x86_64/Release;         cmake "-G${generator}" --debug-trycompile -DCMAKE_CUDA_HOST_COMPILER=icpc -DCMAKE_BUILD_TYPE=Release -DCMAKE_TOOLCHAIN_FILE=TC-icc-cuda-x86_64.cmake ../../..)
